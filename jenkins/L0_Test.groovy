...
//
// PATTERN_CATALOG below is the single source of truth for retryable infra-
// failure recognition. Producers in our own code throw typed InfraFailure
// directly (see <typed:...> markers in detectedPattern); third-party
// exceptions (Jenkins remoting, durable-task plugin, kubelet, SLURM CLI,
// SSH) fall through to catalog-pattern matching.
//
...
// PATTERN_CATALOG: scope-tagged single source of truth for retryable
// infra-failure recognition. Each row tags a third-party exception message
// substring with a severity (TRANSIENT for multi-retry, PERSISTENT for
// single-retry) and a scope (SLURM, K8S, or BOTH).
//
